...
#why divide by 255 im not sure to make it lower numbers to be quicker, not sure
...
```{r}
# underlying data is array of rgb, doesnt show other slices so think this is just for red
...
#applys our final model to test set and tells us the outcome
results
#accuracy of 71.5%
model %>% fit(
  x=train_images, y=train_labels,
  epochs = 1, batch_size = 64, validation_data =list(test_images,test_labels)
)
